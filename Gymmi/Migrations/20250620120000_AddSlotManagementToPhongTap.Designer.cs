...
namespace Gymmi.Migrations
{
    ...
    [Migration("20250620120000_AddSlotManagementToPhongTap")]
    partial class AddSlotManagementToPhongTap
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gymmi.Models.PhongTap", b =>
                {
                    ...
                    b.Property<int?>("ID_TrainerPhuTrach")
                        .HasColumnType("int");

                    b.Property<int>("ID_User")
                        .HasColumnType("int");

                    b.Property<int>("SlotDaDangKy")
                        .HasColumnType("int");

                    b.Property<int>("SlotToiDa")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Gymmi.Models.PhongTap", b =>
                {
                    b.HasOne("Gymmi.Models.User", "TrainerPhuTrach")
                        .WithMany()
                        .HasForeignKey("ID_TrainerPhuTrach");
